...
@Service("EDIT_FINISH")
@Slf4j
public class FinishEditingCallbackProcessor implements EditCallbackProcessor {

    @Autowired private PatientRepository patientRepository;
    @Autowired private RegistrationCache registrationCache;
    @Autowired private RegistrationKeyboards registrationKeyboards;
    ...
    public SendMessage processEditCallback(CallbackQuery callback) {
        ...
        if (new DefaultDateChecker(newPatient.getDateOperation()).isEarlierThen2Months()) {
            ...
            toSend.setReplyMarkup(registrationKeyboards.getTtgKeyboard());
