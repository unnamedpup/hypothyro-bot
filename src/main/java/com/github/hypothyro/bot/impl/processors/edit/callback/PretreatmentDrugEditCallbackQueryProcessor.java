...
@Service("EDIT_PRETREATMENT_NAME")
@Slf4j
public class PretreatmentDrugEditCallbackQueryProcessor implements EditCallbackProcessor {
    ...
    public SendMessage processEditCallback(CallbackQuery callback) {
        ...
        String drugName = callBackData.replace("EDIT_PRETREATMENT_NAME_", "").toLowerCase();
