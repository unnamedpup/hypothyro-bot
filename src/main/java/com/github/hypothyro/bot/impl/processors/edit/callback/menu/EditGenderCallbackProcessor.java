...
@Service("EDIT_GENDER_MENU")
public class EditGenderCallbackProcessor implements EditCallbackProcessor {
    ...
    public SendMessage processEditCallback(CallbackQuery callback) {
        ...
        toSend.setText("Выберите пол");
        toSend.setReplyMarkup(keyboards.editGenderKeyboard);
        stateCache.setState(callback.getMessage().getChatId(), PatientState.EDIT_GENDER);
