...
@Service("EDIT_OPERATION_MENU")
public class EditOperationCallbackProcessor implements EditCallbackProcessor {
    ...
    public SendMessage processEditCallback(CallbackQuery callback) {
        ...
        toSend.setReplyMarkup(keyboards.editOperationKeyboard);
        stateCache.setState(callback.getMessage().getChatId(), PatientState.EDIT_OP);
