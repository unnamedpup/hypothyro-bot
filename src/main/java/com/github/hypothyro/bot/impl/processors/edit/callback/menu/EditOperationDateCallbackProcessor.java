...
@Service("EDIT_OPERATION_DATE_MENU")
public class EditOperationDateCallbackProcessor implements EditCallbackProcessor {
    ...
    public SendMessage processEditCallback(CallbackQuery callback) {
        ...
        toSend.setText("Введите дату операции (в формате дд.мм.гггг):");
        stateCache.setState(callback.getMessage().getChatId(), PatientState.EDIT_DOP);
