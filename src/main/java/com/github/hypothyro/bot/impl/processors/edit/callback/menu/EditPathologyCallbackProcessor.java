...
@Service("EDIT_PATHOLOGY_MENU")
public class EditPathologyCallbackProcessor implements EditCallbackProcessor {
    ...
    public SendMessage processEditCallback(CallbackQuery callback) {
        ...
        toSend.setReplyMarkup(keyboards.editPathologyKeyboard);
        stateCache.setState(callback.getMessage().getChatId(), PatientState.EDIT_PATHOLOGY);
