...
@Service("EDIT_TREATMENT_MENU")
public class EditTreatmentMkgCallbackProcessor implements EditCallbackProcessor {
    ...
    public SendMessage processEditCallback(CallbackQuery callback) {
        ...
        stateCache.setState(callback.getMessage().getChatId(), PatientState.EDIT_TREATMENT_MKG);
